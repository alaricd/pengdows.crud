...
var oracleDb = new DatabaseContext(oracleConnectionString, OracleClientFactory.Instance, tmr);
var pgConnectionString =
    @"Host=localhost;Port=5432;Username=postgres;Password=mysecretpassword;Database=postgres;Pooling=true;Minimum Pool Size=1;Maximum Pool Size=20;Timeout=15;CommandTimeout=30;";
